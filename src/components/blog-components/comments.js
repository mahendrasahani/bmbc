					...
					<div className="ltn__comment-inner">
						...
						<li>
							...
							<div className="ltn__commenter-comment">
								<h6><a href="http://localhost:3001/">Adam Smit</a></h6>
							...
							<li>
								<div className="ltn__comment-item clearfix">
								<div className="ltn__commenter-img">
									<img src={publicUrl+"assets/img/testimonial/3.jpg"} alt="dummy" />
								</div>
								<div className="ltn__commenter-comment">
									<h6><a href="http://localhost:3001/">Adam Smit</a></h6>
						...
						<li>
							<div className="ltn__comment-item clearfix">
							<div className="ltn__commenter-img">
								<img src={publicUrl+"assets/img/testimonial/4.jpg"} alt="dummy" />
							</div>
							<div className="ltn__commenter-comment">
								<h6><a href="http://localhost:3001/">Adam Smit</a></h6>
