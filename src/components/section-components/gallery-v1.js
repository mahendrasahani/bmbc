    ...
    return <div className="ltn__img-slider-area">
				...
				<div className="row ltn__image-slider-4-active slick-arrow-1 slick-arrow-1-inner ltn__no-gutter-all">
					...
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/img-slide/21.jpg"} alt="dummy" />
						</a>
					...
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/img-slide/22.jpg"} alt="dummy" />
						</a>
						<div className="ltn__img-slide-info">
						<div className="ltn__img-slide-info-brief gp-top">
					...
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/img-slide/23.jpg"} alt="dummy" />
						</a>
						<div className="ltn__img-slide-info">
						<div className="ltn__img-slide-info-brief gp-top">
							<h6>The Best City</h6>
					...
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/img-slide/24.jpg"} alt="dummy" />
						</a>
						<div className="ltn__img-slide-info">
						<div className="ltn__img-slide-info-brief gp-top">
