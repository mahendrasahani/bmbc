...
class Testimonial extends Component
{
	...
	render()
	{
		...
		return <div className="ltn__testimonial-area section-bg-1--- bg-image-top pt-115 pb-70" data-bs-bg={"../media/banner/avtarbmbc.jpg"}>
							...
							<div className="ltn__testimoni-info">
								...
								<div className="ltn__testimoni-info-inner">
									<div className="ltn__testimoni-img">
										<img src={"../media/banner/avtarbmbc.jpg"} alt="#" />
									</div>
