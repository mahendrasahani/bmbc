    ...
    return <div className="ltn__team-area pt-110--- pb-90">
				...
				<div className="row justify-content-center go-top">
					...
					<div className="ltn__team-item ltn__team-item-3---">
						...
						<img src={publicUrl+"assets/img/team/4.jpg"} alt="dummy" />
						</div>
						...
						<div className="ltn__social-media">
							<ul>
							<li><a href="http://localhost:3001/"><i className="fab fa-facebook-f" /></a></li>
							<li><a href="http://localhost:3001/"><i className="fab fa-twitter" /></a></li>
							<li><a href="http://localhost:3001/"><i className="fab fa-linkedin" /></a></li>
							</ul>
						</div>
						</div>
					</div>
					...
					<div className="ltn__team-item ltn__team-item-3---">
						<div className="team-img">
						<img src={publicUrl+"assets/img/team/2.jpg"} alt="dummy" />
						</div>
						<div className="team-info">
					...
					<div className="ltn__team-item ltn__team-item-3---">
						<div className="team-img">
						<img src={publicUrl+"assets/img/team/3.jpg"} alt="dummy" />
						</div>
						<div className="team-info">
					...
					<div className="ltn__team-item ltn__team-item-3---">
						<div className="team-img">
						<img src={publicUrl+"assets/img/team/1.jpg"} alt="dummy" />
						</div>
						<div className="team-info">
					...
					<div className="ltn__team-item ltn__team-item-3---">
						<div className="team-img">
						<img src={publicUrl+"assets/img/team/5.jpg"} alt="dummy" />
						</div>
						<div className="team-info">
					...
					<div className="ltn__team-item ltn__team-item-3---">
						<div className="team-img">
						<img src={publicUrl+"assets/img/team/6.jpg"} alt="dummy" />
						</div>
						<div className="team-info">
