    ...
    return <div className="ltn__img-slider-area mb-90">
				...
				<div className="row ltn__image-slider-5-active slick-arrow-1 slick-arrow-1-inner ltn__no-gutter-all">
					...
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/img-slide/31.jpg"} alt="dummy" />
						</a>
					</div>
					</div>
					<div className="col-lg-12">
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/img-slide/32.jpg"} alt="dummy" />
						</a>
					</div>
					</div>
					<div className="col-lg-12">
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/img-slide/33.jpg"} alt="dummy" />
						</a>
					</div>
					</div>
					<div className="col-lg-12">
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/img-slide/34.jpg"} alt="dummy" />
						</a>
					</div>
					</div>
					<div className="col-lg-12">
					<div className="ltn__img-slide-item-4">
						...
						<img src={publicUrl+"assets/img/img-slide/35.jpg"} alt="dummy" />
						</a>
					</div>
					</div>
				</div>
