    ...
    return (
		<div className="col-lg-4  mb-100">
			...
			<div className="widget ltn__menu-widget d-none">
				...
				<ul>
				<li><a href="http://localhost:3001/">Body <span><i className="fas fa-long-arrow-alt-right" /></span></a></li>
				<li><a href="http://localhost:3001/">Interior <span><i className="fas fa-long-arrow-alt-right" /></span></a></li>
				<li><a href="http://localhost:3001/">Lights <span><i className="fas fa-long-arrow-alt-right" /></span></a></li>
				<li><a href="http://localhost:3001/">Parts <span><i className="fas fa-long-arrow-alt-right" /></span></a></li>
				<li><a href="http://localhost:3001/">Tires <span><i className="fas fa-long-arrow-alt-right" /></span></a></li>
				<li><a href="http://localhost:3001/">Uncategorized <span><i className="fas fa-long-arrow-alt-right" /></span></a></li>
				<li><a href="http://localhost:3001/">Wheel <span><i className="fas fa-long-arrow-alt-right" /></span></a></li>
				</ul>
			</div>
			{/* Price Filter Widget */}
			...
			<div className="widget ltn__top-rated-product-widget d-none">
				...
				<li>
					...
					<div className="top-rated-product-info">
						...
						<ul>
							<li><a href="http://localhost:3001/"><i className="fas fa-star" /></a></li>
							<li><a href="http://localhost:3001/"><i className="fas fa-star" /></a></li>
							<li><a href="http://localhost:3001/"><i className="fas fa-star" /></a></li>
							<li><a href="http://localhost:3001/"><i className="fas fa-star" /></a></li>
							<li><a href="http://localhost:3001/"><i className="fas fa-star" /></a></li>
				...
				<li>
					...
					<div className="top-rated-product-info">
						...
						<ul>
							...
							<li><a href="http://localhost:3001/"><i className="fas fa-star" /></a></li>
							<li><a href="http://localhost:3001/"><i className="fas fa-star" /></a></li>
							<li><a href="http://localhost:3001/"><i className="fas fa-star-half-alt" /></a></li>
							<li><a href="http://localhost:3001/"><i className="far fa-star" /></a></li>
						</ul>
						</div>
			...
			<div className="widget ltn__tagcloud-widget d-none">
				...
				<ul>
				<li><a href="http://localhost:3001/">Popular</a></li>
				<li><a href="http://localhost:3001/">desgin</a></li>
				<li><a href="http://localhost:3001/">ux</a></li>
				<li><a href="http://localhost:3001/">usability</a></li>
				<li><a href="http://localhost:3001/">develop</a></li>
				<li><a href="http://localhost:3001/">icon</a></li>
				<li><a href="http://localhost:3001/">Car</a></li>
				<li><a href="http://localhost:3001/">Service</a></li>
				<li><a href="http://localhost:3001/">Repairs</a></li>
				<li><a href="http://localhost:3001/">Auto Parts</a></li>
				<li><a href="http://localhost:3001/">Oil</a></li>
				<li><a href="http://localhost:3001/">Dealer</a></li>
				<li><a href="http://localhost:3001/">Oil Change</a></li>
				<li><a href="http://localhost:3001/">Body Color</a></li>
				</ul>
			</div>
			{/* Size Widget */}
			<div className="widget ltn__tagcloud-widget ltn__size-widget d-none">
				...
				<ul>
				<li><a href="http://localhost:3001/">S</a></li>
				<li><a href="http://localhost:3001/">M</a></li>
				<li><a href="http://localhost:3001/">L</a></li>
				<li><a href="http://localhost:3001/">XL</a></li>
				<li><a href="http://localhost:3001/">XXL</a></li>
				</ul>
			</div>
			{/* Color Widget */}
			<div className="widget ltn__color-widget d-none">
				...
				<ul>
				<li className="black"><a href="http://localhost:3001/" /></li>
				<li className="white"><a href="http://localhost:3001/" /></li>
				<li className="red"><a href="http://localhost:3001/" /></li>
				<li className="silver"><a href="http://localhost:3001/" /></li>
				<li className="gray"><a href="http://localhost:3001/" /></li>
				<li className="maroon"><a href="http://localhost:3001/" /></li>
				<li className="yellow"><a href="http://localhost:3001/" /></li>
				<li className="olive"><a href="http://localhost:3001/" /></li>
				<li className="lime"><a href="http://localhost:3001/" /></li>
				<li className="green"><a href="http://localhost:3001/" /></li>
				<li className="aqua"><a href="http://localhost:3001/" /></li>
				<li className="teal"><a href="http://localhost:3001/" /></li>
				<li className="blue"><a href="http://localhost:3001/" /></li>
				<li className="navy"><a href="http://localhost:3001/" /></li>
				<li className="fuchsia"><a href="http://localhost:3001/" /></li>
				<li className="purple"><a href="http://localhost:3001/" /></li>
				<li className="pink"><a href="http://localhost:3001/" /></li>
				<li className="nude"><a href="http://localhost:3001/" /></li>
				<li className="orange"><a href="http://localhost:3001/" /></li>
				<li><a href="http://localhost:3001/" className="orange" /></li>
				<li><a href="http://localhost:3001/" className="orange" /></li>
				</ul>
			</div>
			{/* Banner Widget */}
