				...
				<div className="container">
						<div className="row">
								...
								<div className="ltn__product-tab-content-inner ltn__product-grid-view">
									...
									<div className="col-lg-4 col-sm-6 col-12">
										...
										<div className="product-info">
											...
											<ul>
												<li>
												<a href="http://localhost:3001/" title="Quick View" data-bs-toggle="modal" data-bs-target="#quick_view_modal">
													<i className="flaticon-expand" />
												</a>
												</li>
												<li>
												<a href="http://localhost:3001/" title="Wishlist" data-bs-toggle="modal" data-bs-target="#liton_wishlist_modal">
							...
							<div className="ltn__pagination-area text-center">
								...
								<ul>
									<li><a href="http://localhost:3001/"><i className="fas fa-angle-double-left" /></a></li>
									<li><a href="http://localhost:3001/">1</a></li>
									<li className="active"><a href="http://localhost:3001/">2</a></li>
									<li><a href="http://localhost:3001/">3</a></li>
									<li><a href="http://localhost:3001/">...</a></li>
									<li><a href="http://localhost:3001/">10</a></li>
									<li><a href="http://localhost:3001/"><i className="fas fa-angle-double-right" /></a></li>
								</ul>
								</div>
							</div>
							</div>
							...
							<div className="row">
								...
								<div className="modal-product-info">
									...
									<ul>
										...
										<li className="review-total"> <a href="http://localhost:3001/"> ( 95 Reviews )</a></li>
									</ul>
									</div>
									...
									<ul>
										...
										<li>
										<a href="http://localhost:3001/" className="theme-btn-1 btn btn-effect-1" title="Add to Cart" data-bs-toggle="modal" data-bs-target="#add_to_cart_modal">
									...
									<ul>
										<li>Share:</li>
										<li><a href="http://localhost:3001/" title="Facebook"><i className="fab fa-facebook-f" /></a></li>
										<li><a href="http://localhost:3001/" title="Twitter"><i className="fab fa-twitter" /></a></li>
										<li><a href="http://localhost:3001/" title="Linkedin"><i className="fab fa-linkedin" /></a></li>
										<li><a href="http://localhost:3001/" title="Instagram"><i className="fab fa-instagram" /></a></li>
									</ul>
									</div>
								</div>
								</div>
